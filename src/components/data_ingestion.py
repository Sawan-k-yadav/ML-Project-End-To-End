...
if __name__=="__main__":
    ...
    train_arr,test_arr,_= data_transformation.initiate_data_transformation(train_data, test_data)   # train_arr,test_arr,_=    part added after creating model trainer file for getting training and testing  array from data trasnformation
